...
cv2.imwrite(Bildname+"Rot"+Programmname+".jpg", R)
cv2.imwrite(Bildname+"_Blau"+Programmname+".jpg", B)
cv2.imwrite(Bildname+"_Gruen"+Programmname+".jpg", G)
